...
@todo a where function, e.g. `o.where({ a:1, b:0 }, function(key, value){ return value > 0; })`
*/
...
@param {object} - The input object
@param {string[]|function} - Either an array of property names, or a function. The function must return `true` to be included in the output.
@returns {object}
@example
> object = { a: 1, b: 0, c: 2 }
{ a: 1, b: 0, c: 2 }
...
function where(object, query){
    ...
    if (typeof query === "function"){
        for (var prop in object){
            if (query(prop, object[prop]) === true) output[prop] = object[prop];
        }
